...
class RBTree(BinSearchTree):
	...
	def deleteValue(self, value):
		...
		tobeDel = self._delLeaf(leafNode)

		if tobeDel is not None:
			delNode.content = tobeDel.content
